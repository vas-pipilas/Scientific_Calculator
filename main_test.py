...
button_data = [
    ...
    ("π", lambda: add_to_calculation("π")), ("e", lambda: add_to_calculation("e")),
    ...
    ("|x|", lambda: add_to_calculation("|x|")), ("PH", None), ("mod", lambda: add_to_calculation("mod")),
    ...
    ("PH", None), ("4", lambda: add_to_calculation("4")), ("5", lambda: add_to_calculation("5")),
